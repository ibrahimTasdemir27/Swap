...
final class AdvertAutoFirstStepViewController: AdvertViewControllerType, AlertPresentable, FormFieldRequirementsUnwrapper {
  ...
  // MARK: - IBActions
    ...
    @IBAction func tappedContinueButton(_ sender: Any) {
        ...
        viewModel.advertHeading = advertHeadingField.safeText()
        viewModel.advertDescription = advertDescriptionField.safeText()
...
// MARK: - ViewModel Delegate -
extension AdvertAutoFirstStepViewController: AllAdvertRequirementsController {
